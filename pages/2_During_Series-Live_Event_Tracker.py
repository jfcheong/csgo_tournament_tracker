...
with duringround_tab:
    ...
    def get_player_kda(kda_df, latest_round_df, player_df, index):
        ...
        kda_str = kda_filtered["kills"].values[0].astype(str) + "/" + kda_filtered["deaths"].values[0].astype(str) + "/" + kda_filtered["killAssistsGiven"].values[0].astype(str)
        return kda_str
